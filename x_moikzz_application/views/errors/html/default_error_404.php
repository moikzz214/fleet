<html lang="en"><head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?=imgs_dir('favicon.png')?>">
    <title>Page not found</title>
    <!-- Bootstrap Core CSS -->
    <link href="<?=plugins_dir('bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?=file_common_dir_back('css/style.css')?>" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="<?=file_common_dir_back('css/colors/blue.css')?>" id="theme" rel="stylesheet">
...
<body class="fix-header card-no-border">
    ...
    <!--Wave Effects -->
    <script src="<?=file_common_dir_back('js/waves.js')?>"></script> 
</body></html>